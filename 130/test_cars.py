...
test_get_models_mercedes()
test_get_models_nissan()
test_get_models_open()
test_get_models_volkswagen()
test_most_prolific_automaker_1999()
test_most_prolific_automaker_2008()
test_most_prolific_automaker_2013()